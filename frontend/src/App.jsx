...
// Puedes reemplazar esta lista por datos cargados desde tu backend o desde el Excel
    ...
    <div style={appStyles}>
      <Router>
        ...
        <Routes>
          ...
          {/* Cualquier ruta desconocida redirige al dashboard o al login */}
          <Route
            path="*"
            element={
              isAuth ? (
